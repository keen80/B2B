...
Tmo.logError = function()
{
    var e = arguments[0],
            errorDetails = {
                browser: navigator.userAgent,
                message: e.message,
                stacktrace: printStackTrace({e: e})
            };

    if ( arguments.length > 1 ) {
        errorDetails.details = arguments[1];
    }

    Ext.Ajax.request({
        method: "POST",
        url: Tmo.getServerAddress("/jserror"),
        params: {
...
Tmo.tryCatch = function(callback, details)
{
    if (TmoConfig.debug) {
        callback.call();
    } else {
...
Ext.data.Store / loadRecords TODO
*/
