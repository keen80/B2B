...
Ext.define('Ext.ux.bufferedlist.BufferedList', {
    ...
    config: {
		...
		initComponent: function() {
			...
			Ext.ux.bufferedlist.BufferedList.superclass.initComponent.call(this);
	...
	initEvents: function() {
		Ext.ux.bufferedlist.BufferedList.superclass.initEvents.call(this);
	...
	refresh: function() {
		...
		Ext.ux.bufferedlist.BufferedList.superclass.refresh.apply(this,arguments);
	...
	afterRender: function() {
		Ext.ux.bufferedlist.BufferedList.superclass.afterRender.apply(this,arguments);
    ...
    getNode : function(nodeInfo) {
		...
		return Ext.ux.bufferedlist.BufferedList.superclass.getNode.call(this, nodeInfo);
	},
